...
import { ERIC_TOKEN_PERMIT_ABI, TOKEN_BANK_PERMIT_ABI } from '@/constants/abis';
...
export default function TokenBankPrimit() {
  ...
  const { data: tokenBalance, refetch: refetchTokenBalance } = useReadContract({
    address: CONTRACTS_PERMIT.EricTokenPermit as AddressType,
    abi: ERIC_TOKEN_PERMIT_ABI,
  ...
  const handlePermitDeposit = () => {
    ...
    const domain = {
      name: 'EricTokenPermit',
      version: '1',
      chainId: chain.id,
      verifyingContract: CONTRACTS_PERMIT.EricTokenPermit as AddressType,
    };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="text-2xl font-semibold text-gray-900">
            {tokenBalance ? formatEther(tokenBalance as bigint) : '0'} {tokenSymbol || 'ETP'}
          </p>
        </div>
        <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
          <h3 className="text-sm text-gray-500 mb-1">Bank Deposit Balance</h3>
          <p className="text-2xl font-semibold text-gray-900">
            {bankBalance ? formatEther(bankBalance as bigint) : '0'} {tokenSymbol || 'ETP'}
          </p>
        </div>
      </div>
