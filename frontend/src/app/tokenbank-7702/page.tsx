...
import { ERIC_TOKEN_ABI, TOKEN_BANK_ABI } from '@/constants/abis';
...
export default function TokenBank7702() {
  ...
  const { data: tokenBalance, refetch: refetchTokenBalance } = useReadContract({
    address: CONTRACTS.EricToken as AddressType,
    abi: ERIC_TOKEN_ABI,
  ...
  const handleBatchDeposit = () => {
    ...
    executeBatch({
      ...
      args: [CONTRACTS.EricToken as AddressType, CONTRACTS.TokenBank as AddressType, amount],
    });
  };
