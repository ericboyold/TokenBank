...
import { ERIC_TOKEN_V2_ABI, TOKEN_BANK_V2_ABI } from '@/constants/abis';
...
export default function TokenBankV2() {
  ...
  const { data: tokenBalance, refetch: refetchTokenBalance } = useReadContract({
    address: CONTRACTS_V2.EricTokenV2 as AddressType,
    abi: ERIC_TOKEN_V2_ABI,
      ...
      <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-600">
            Current Allowance: {allowance ? formatEther(allowance as bigint) : '0'} {tokenSymbol || 'ETK'}
          </div>
